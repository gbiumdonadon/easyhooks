...
echo ""
echo "Next steps:"
echo "  1. Start the stack: docker compose -f docker-compose.yml -f docker-compose.loadtest.yml up -d"
echo "  2. Create test tenants: cd load_tests && python utils/tenant_factory.py --create --count 50"
echo "  3. Run load test: locust -f scenarios/baseline.py --host=http://localhost:8000"
echo ""
